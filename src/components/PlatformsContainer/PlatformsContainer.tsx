...
import googleIcon from "../../../public/assets/icons/Logo Google.svg";
import twitterIcon from "../../../public/assets/icons/twitter-logo.svg";
import facebookIcon from "../../../public/assets/icons/fb-logo.svg";
import appleIcon from "../../../public/assets/icons/apple-logo.svg";
export default function PlatformsContainer() {
  return (
    <div className="platforms">
      <p className="hr-line relative text-center text-text-color mb-[32px]">
        Or Continue with
      </p>
